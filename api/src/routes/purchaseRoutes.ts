...
router.post('/', purchaseValidation, purchaseController.createPurchase.bind(purchaseController));
router.put('/:id', purchaseUpdateValidation, purchaseController.updatePurchase.bind(purchaseController));
router.delete('/:id', purchaseController.deletePurchase.bind(purchaseController));
